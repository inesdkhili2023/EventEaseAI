...
import { CreatePartnershipComponent } from './pages/ecommerce-page/e-create-product/e-create-product.component';import { CrmPageComponent } from './pages/crm-page/crm-page.component';
...
import { PredictBudgetComponent } from './dashboard/predict-budget/predict-budget.component';
import { AddEventFeaturesComponent } from './dashboard/add-event-features/add-event-features.component';
import { ListEventFeaturesComponent } from './dashboard/list-event-features/list-event-features.component';
...
import { TicketListComponent } from './pages/ticket-management/ticket-plans-list/ticket-plans-list.component';
import { TicketFormComponent } from './pages/ticket-management/ticket-plan-form/ticket-plan-form.component';
import { PaymentFormComponent } from './pages/ticket-management/payment/payment.component';
import { PaymentHistoryComponent } from './dashboard/crm/payment-history/payment-history.component';

export const routes: Routes = [
    {path: '', component: EcommerceComponent},
    {path: 'crm', component: CrmComponent},
    {path: 'admin/project-management', component: ProjectManagementComponent},
    {path: 'chauffeur/lms', component: LmsComponent},
    {path: 'help-desk', component: HelpDeskComponent},
    {path: 'predict-budget', component: PredictBudgetComponent},
    {path: 'add-event-features', component: AddEventFeaturesComponent},
    {path: 'list-event-features', component: ListEventFeaturesComponent},
    ...
    },
    {
        ...
        children: [
            ...
            {path: 'create-product', component: CreatePartnershipComponent},
    ...
    },
    {
        ...
        children: [
            ...
            {path: 'create-an-event/:id', component: CreateAnEventComponent}, // 👈 AJOUTEZ CETTE LIGNE
// 🎟️ Ticket Management routes
        {
            path: ':eventId/tickets',
            children: [
                { path: '', component: TicketListComponent },
                { path: 'new', component: TicketFormComponent},
                { path: ':categoryId/edit', component: TicketFormComponent }
            ]
        },

        // 💳 Payment routes
        { path: ':eventId/purchase', component: PaymentFormComponent },
        { path: ':eventId/payments', component: PaymentHistoryComponent }
    ...
    },
     {
        ...
        loadComponent: () => import('./pages/ticket-management/ticket-management.component').then(m => m.TicketManagementComponent)
    },
