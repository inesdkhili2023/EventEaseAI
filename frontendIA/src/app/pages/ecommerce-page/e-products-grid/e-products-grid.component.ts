...
@Component({
    ...
    standalone: true,
    providers: [
    EventService,PartnershipService
  ],
    imports: [CommonModule, HttpClientModule, MatCardModule, MatMenuModule, MatButtonModule, RouterLink, MatSelectModule, FormsModule, ReactiveFormsModule, SponsorsBannerComponent],
