...
@Component({
    ...
    imports: [CommonModule,HttpClientModule, RouterLink, MatCardModule, MatButtonModule, FeathericonsModule, CarouselModule, NgFor, MatProgressBarModule, MatMenuModule, OutletsDetailsComponent, ReviewsComponent],
