...
@Component({
    ...
    imports: [CommonModule, MatCardModule, MatButtonModule, FeathericonsModule, CarouselModule, MatProgressBarModule, MatMenuModule, OutletsDetailsComponent, ReviewsComponent],
