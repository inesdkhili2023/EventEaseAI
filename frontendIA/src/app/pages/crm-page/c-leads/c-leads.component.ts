...
@Component({
    ...
    standalone: true,
    imports: [MatIconModule, LeadsStaticsComponent, StatsComponent, RouterLink, MatCardModule, MatButtonModule, MatMenuModule, MatPaginatorModule, MatTableModule, NgIf, AddEventFeaturesComponent, PredictBudgetComponent],
