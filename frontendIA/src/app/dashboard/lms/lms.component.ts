...
@Component({
    selector: 'app-lms',
    standalone: true,
    imports: [StatsComponent, CoursesCategoryComponent, TopInstructorsComponent, StudentsProgressComponent, AllCoursesComponent, TotalPerformanceComponent, CoursesOverviewComponent, DailyPerformanceComponent, WebsiteOverviewComponent, CalendarDriverComponent, ModifyDriverComponent],
