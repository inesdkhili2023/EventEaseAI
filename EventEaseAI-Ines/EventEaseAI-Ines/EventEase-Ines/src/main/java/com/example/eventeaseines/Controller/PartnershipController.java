...
public class PartnershipController {
    ...
    public ResponseEntity<?> update(
        ...
        try {
            ...
            existing.setName(updatedPartnership.getName());
            existing.setType(updatedPartnership.getType());
            existing.setDescription(updatedPartnership.getDescription());
            existing.setContractValue(updatedPartnership.getContractValue());
            existing.setStartDate(updatedPartnership.getStartDate());
            existing.setEndDate(updatedPartnership.getEndDate());
            existing.setActive(updatedPartnership.getActive());
            // Optionnel : gérer imageUrl si tu veux permettre un changement d'image via JSON
            if (updatedPartnership.getImageUrl() != null) {
                existing.setImageUrl(updatedPartnership.getImageUrl());
            }

            existing.setUpdatedAt(new Date());
            Partnership saved = partnershipRepo.save(existing);
