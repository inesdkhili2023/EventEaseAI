...
import { LogisticsDashboardComponent } from './dashboard/logistics-dashboard/logistics-dashboard.component';
import { LogisticsListComponent } from './dashboard/logistics-dashboard/logistics-list/logistics-list.component';
...
export const routes: Routes = [
    ...
    {path: 'logistics-dashboard/list', component: LogisticsListComponent},
