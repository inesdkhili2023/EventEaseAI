                ...
                <mat-tab-group>
                    ...
                    <mat-tab>
                        ...
                        <div class="tab-content">
                            <p class="info-text">Sélectionnez un événement manuellement</p>
                            ...
                            <mat-form-field appearance="outline" class="full-width" *ngIf="!loadingEvents">
                                ...
                                <mat-select [(ngModel)]="selectedEventId">
                                    <mat-option *ngFor="let event of allEvents" [value]="event.id">
                                        <div class="event-option">
                                            ...
                                            <span class="event-type" *ngIf="event.type">{{ event.type }}</span>
                                        </div>
                                    </mat-option>
                                </mat-select>
                                <mat-icon matPrefix>event</mat-icon>
                        ...
                        <div class="tab-content">
                            <div class="ai-header">
                                ...
                                <div>
                                    ...
                                    <p>Basées sur TF-IDF et similarité sémantique</p>
                                </div>
                            </div>
