...
export class OrderInfoModalComponent implements OnInit {
  ...
  constructor(
    @Inject(MAT_DIALOG_DATA) public data: any, // Ajuster en fonction des données réelles
    private printerService: PrinterService,
    public dialogRef: MatDialogRef<OrderInfoModalComponent>, // Ajouter ici
  ...
  onNoClick(): void {
    this.dialogRef.close(); // Utiliser dialogRef pour fermer le dialogue
  }
